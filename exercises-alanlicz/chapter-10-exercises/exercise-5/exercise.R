...
names <- read.csv("/Users/alanli/Documents/UW/INFO201/exercises-alanlicz/chapter-10-exercises/exercise-5/data/female_names.csv", stringsAsFactors = FALSE)
...
Alan_2000 <- number_in_million("Alan", 2000)
